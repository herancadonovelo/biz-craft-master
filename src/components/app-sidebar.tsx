...
const getGroups = (t: (k: string) => string) => [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Diagnóstico de Pagamentos", url: "/diagnostico-pagamentos", icon: CreditCard },
      { title: "Auditoria de Eventos", url: "/auditoria-pagamentos", icon: Shield },
      { title: "Guia do Teste Real", url: "/guia-teste-live", icon: Receipt },
