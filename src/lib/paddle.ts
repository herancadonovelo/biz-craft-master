...
/** ID de preco no Paddle para cada plano/ciclo da app. */
export function paddlePriceIdFor(plan: "base" | "premium", cycle: "mensal" | "anual"): string {
  return `${plan}_${cycle === "anual" ? "yearly" : "monthly"}`;
}
