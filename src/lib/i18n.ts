...
const pt: Dict = {
  ...
  "nav.supplierMgmt": "Gestão De Fornecedores",
...
const es: Dict = {
  ...
  "nav.profile": "Perfil del negocio",
...
const fr: Dict = {
  ...
  "nav.profile": "Profil de l'entreprise",
